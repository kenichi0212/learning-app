<div class="border rounded-lg p-10 bg-white shadow-sm relative text-center">
    <div class="relative flex items-center justify-center mb-4 min-h-[40px]">
        <h2 class="text-gray-600 font-bold absolute left-0">カメラモニター</h2>
        ...
        <span class="text-sm font-bold text-gray-500 absolute right-0" id="cameraStatusText">OFF</span>
    </div>

    <div class="bg-zinc-800 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden mx-auto max-w-2xl">
        <video id="webcam" autoplay playsinline muted class="hidden w-full h-full object-cover"></video>
        <p id="offMessage" class="text-white text-2xl">カメラがオフです</p>
    </div>
</div>