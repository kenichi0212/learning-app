<x-app-layout>
    ...
    <x-page-container>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            {{-- 累計学習時間 --}}
            <x-card title="累計学習時間" class="p-8 text-center">
            ...
            {{-- 今日の集中時間：清潔感のあるデザイン --}}
            <x-card title="今日の集中時間" class="p-8 text-center">
                <p class="text-4xl font-black text-slate-800">
