    ...
    <div class="mt-6 space-y-4">
        <div class="flex items-center justify-between p-4 border rounded-lg border-gray-300 shadow-sm">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="is_camera_enabled" id="is_camera_enabled" value="1" class="sr-only peer"
        ...
        <div class="flex items-center justify-between p-4 border rounded-lg border-gray-300 shadow-sm">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="is_screenshot_enabled" id="is_screenshot_enabled" value="1" class="sr-only peer"
